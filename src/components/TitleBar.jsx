    ...
    <div className="h-8 flex items-center justify-between bg-base-975 shrink-0 [-webkit-app-region:drag]">
      ...
      <div className="flex [-webkit-app-region:no-drag]">
        <button
          ...
          className="w-10 h-8 grid place-items-center hover:bg-tint/[0.06] text-ink-500 hover:text-ink-300 transition-colors"
        >
        ...
        <button
          ...
          className="w-10 h-8 grid place-items-center hover:bg-red-500/90 text-ink-500 hover:text-white transition-colors"
        >
